jQuery(function ($) {
    ...
    $('#country-popup').on('click', '#getCities ul li .statedata', function (e) {
		...
		var ajaxurl= $('#uribase').val()+'/get-cities-by-state';
    ...
    $('#country-popup').on('click', '#getCities ul li #changeState', function (e) {
		...
		var ajaxurl= $('#uribase').val()+'/get-states';
...
$(function () {
    ...
    $("#inputStateCity").keyup(function () {
		...
		var ajaxurl= $('#uribase').val()+'/get-cities';
