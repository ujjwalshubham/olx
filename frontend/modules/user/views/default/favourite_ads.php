...
$this->title = Yii::t('frontend', 'Favourite Ads') . ' | OLX';
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="section-title my_ads_title ">
                <h2><?php echo Yii::t('frontend', 'Favourite Ads')?></h2>
              </div>
              <div class="featured_slider h_products table-responsive">
				  ...
				  <table class="table_my_ads">
					  ...
					  <?php if(!empty($favourite_ads)){?>  
					  <tbody>
						  
						  
					<?php foreach($favourite_ads as $key=>$myad){?>
					  	<tr>
							<td class="title-container">
							    ...
							    <div class="item-title new-item-title">
                                        ...
                                        <?php $city_name = Cities::getCityById($myad['city']);?>
                                        <ul class="item-details">
											<?php if(isset($city_name) && !empty($city_name )){?>
                                            <li><i class="fa fa-map-marker"></i><a href="javascript:void(0)"><?php echo $city_name['name']?></a></li>
                                            <?php } ?>
                                         ...
                                         <?php } ?>
                                         <a href="<?php echo $baseUrl.'/user/ad-detail/'.$myad['slug']?>"><span class="table-item-price view_ad"> View Ad </span></a>
							...
							<!--<td class="action">
								<a href=""><i class="fa fa-pencil"></i> <?php echo Yii::t('frontend', 'Edit')?></a><br>
								<a class="delete item-js-delete" href="javascript:void(0)" ><i class="fa fa-remove"></i> <?php echo Yii::t('frontend', 'Delete')?></a>
							</td>-->
						</tr>
						  <?php } ?>
