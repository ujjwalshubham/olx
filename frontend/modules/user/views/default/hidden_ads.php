...
$this->title = Yii::t('frontend', 'Hidden Ads') . ' | OLX';
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="section-title my_ads_title ">
                <h2><?php echo Yii::t('frontend', 'Hidden Ads')?></h2>
              </div>
				  ...
				  <table class="table_my_ads">
					...
					<?php foreach($pending_ads as $key=>$myad){?>
					  	<tr>
							...
							<td class="item_status"><span class="label status_label"><?php echo $myad['status']?></span></td>
							<td class="action">
								<a href="<?php echo $baseurl.'/user/edit-ad/'.$myad['id']; ?>"><i class="fa fa-pencil"></i> <?php echo Yii::t('frontend', 'Edit')?></a><br>
								<a class="hide item-js-hide" attr-id="<?php echo $myad['id']?>" href="javascript:void(0)" ><i class="fa fa-eye"></i> <?php echo Yii::t('frontend', 'Unhide')?></a>
							</td>
						</tr>
						  <?php } ?>
