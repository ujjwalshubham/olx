...
$this->title = Yii::t('frontend', 'Resubmitted Ads') . ' | OLX';
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="section-title my_ads_title ">
                <h2><?php echo Yii::t('frontend', 'Resubmitted Ads')?></h2>
              </div>
              <div class="featured_slider h_products table-responsive">
				  ...
				  <table class="table_my_ads">
					  ...
					  <?php if(!empty($resubmit_ads)){?>  
					   <tbody>
                              <?php foreach($resubmit_ads as $key=>$myad){?>
                              <tr>
                                 ...
                                 <td class="item_status"><span class="label status_label<?php echo$myad['id'];?>"><?php echo $myad['status']?></span></td>
                                 <td class="action">
                                    <?php if($myad['status']!='Rejected'){?>
