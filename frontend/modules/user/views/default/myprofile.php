            ...
            <div class="row">
               ...
               <div class="col-sm-12 col-lg-6">
                  <div class="user-admin">
                     <?php if(empty($UserProfile->name) && empty(Yii::$app->user->identity->email)){?>
                     <p class="pro_detail"><?php echo Yii::t('frontend', 'Please complete your profile details')?></p>
                     <?php }?>
                     ...
                     <section class="contacts">
                        ...
                        <figure class="social-links"><a href="javascript:void(0)"><i class="fa fa-envelope"></i><?php echo Yii::$app->user->identity->email?></a></figure>
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="dropdown category-dropdown open">
                     <a data-toggle="dropdown" href="javascript:void(0)" aria-expanded="true"><span class="change-text">
               ...
               <input type="hidden" id="searchPlaceType" name="placetype"  value="">
               <input type="hidden" id="searchPlaceId" name="placeid"  value="">
