...
class SignInController extends \yii\web\Controller
{
                ...
                'rules' => [
                    ...
                    [
                        ...
                        'denyCallback' => function () {
                             return Yii::$app->controller->redirect(['/user/dashboard']);
                        }
                    ],
                    [
                        'actions' => ['logout'],
    ...
    public function actionSignupOld()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
           $user = $model->signup();
           if($user){
			  Yii::$app->response->redirect(['otp-verification','user' =>$user]);
		   }
        }
    ...
    public function successOAuthCallback($client)
    {
        ...
        if (!$user) {
            ...
            $user->mobile = ArrayHelper::getValue($attributes, 'login');
            ...
            if ($user->save()) {
                ...
                if ($client->getName() === 'facebook') {
                    $profileData['name'] = ArrayHelper::getValue($attributes, 'first_name').' '.ArrayHelper::getValue($attributes, 'last_name');
                }
