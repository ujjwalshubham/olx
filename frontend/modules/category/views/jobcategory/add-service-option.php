...
<div class="user-form">
    ...
    <?php echo $form->field($model, 'servicename')->textInput(['value' => $servicename['servicename'], 'readonly' => true]); ?>
    <?php echo $form->field($model, 'service_type_id')->textInput(['value' => $servicename['id'], 'type' => 'hidden'])->label(false); ?>
