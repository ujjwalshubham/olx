            ...
            <div class="row">
               ...
               <div class="col-md-3 banner-icon">
                  ...
                  <div class="form-group live-location-search">
                     ...
                     <?php } else {?>
					  <input type="hidden" id="input-maincat" name="cat" value="<?php $category['id']?>"/>	 
					 <?php } ?>
                     ...
                     <div class="row full" id="getCities">
                        ...
                        <div id="results" class="animate-bottom">
                           <ul class="column col-md-12 col-sm-12 cities">
                              <li class="active">
                                 <a href="javascript:void(0)" class="selectme" data-id="in" data-name="All India" data-type="country">All india<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                              </li>
