        ...
        <a class="card" href="#">
            <div class="card-block clearfix">
                <div class="pull-right">
                    ...
                    <p class="h3 text-blue m-t-sm m-b-0"><?php echo $activeAdsCount; ?></p>
                </div>
        ...
        <a class="card bg-green bg-inverse" href="#">
            <div class="card-block clearfix">
                <div class="pull-right">
                    ...
                    <p class="h3 m-t-sm m-b-0"><?php echo $newAdsCount; ?> New</p>
                </div>
                <div class="pull-left m-r">
        ...
        <a class="card bg-purple bg-inverse" href="#">
            <div class="card-block clearfix">
                <div class="pull-right">
                    ...
                    <p class="h3 m-t-sm m-b-0"><?php echo $allusersCount; ?></p>
                </div>
                <div class="pull-left m-r">
        ...
        <a class="card bg-blue bg-inverse" href="#">
            <div class="card-block clearfix">
                <div class="pull-right">
                    ...
                    <p class="h3 m-t-sm m-b-0"><?php echo $alltransaction; ?> &#8377;</p>
                </div>
                <div class="pull-left m-r">
